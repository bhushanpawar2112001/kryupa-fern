...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:#f7faf8;color:#0f2419;line-height:1.75;font-size:16px}
.wrap{max-width:760px;margin:0 auto;padding:48px 24px 80px}
header{border-bottom:2px solid #2d7a4f;padding-bottom:20px;margin-bottom:36px}
.logo{display:flex;align-items:center;gap:8px;margin-bottom:10px;text-decoration:none}
.logo-name{font-size:20px;font-weight:800;color:#2d7a4f;letter-spacing:2px}
h1{font-size:26px;font-weight:700;margin-bottom:4px}
.meta{font-size:13px;color:#4a6553}
h2{font-size:17px;font-weight:700;color:#0f2419;margin:32px 0 10px;padding-left:12px;border-left:3px solid #2d7a4f}
p{margin-bottom:14px;color:#2a3d2f}
ul{margin:6px 0 14px 20px}
li{margin-bottom:7px;color:#2a3d2f}
a{color:#2d7a4f}
.badge{display:inline-block;background:#eaf5ee;color:#2d7a4f;border:1px solid #b7dfc8;border-radius:20px;padding:5px 14px;font-size:12px;font-weight:600;margin-bottom:18px}
footer{border-top:1px solid #dde7e2;margin-top:48px;padding-top:18px;font-size:13px;color:#8faf99;text-align:center}
</style>
</head>
<body>
<div class="wrap">
<header>
  <a class="logo" href="${APP_WEBSITE}"><span style="font-size:24px">🌿</span><span class="logo-name">kryupa</span></a>
  <h1>${title}</h1>
...
<ul>
  ...
  <li><strong>Health profile data:</strong> dietary preferences, allergies, medical
      conditions, and medications you voluntarily enter to personalise product scores.
      This data is stored on our servers and is never sold.</li>
...
<p>We do <strong>not</strong> sell, trade, or rent your personal information.
We share data only with trusted service providers:</p>
<ul>
  <li><strong>Firebase (Google LLC)</strong> — authentication and crash analytics.</li>
  <li><strong>MongoDB Atlas (MongoDB, Inc.)</strong> — secure cloud database storage.</li>
...
password hashing, and TLS/HTTPS for all data in transit.</p>

<h2>6. Children's Privacy</h2>
<p>Our App is not directed to children under 13. We do not knowingly collect personal
information from children. If you believe your child has provided us data, please
contact us immediately.</p>

<h2>7. Your Rights</h2>
<p>You may request access, correction, or deletion of your personal data at any time
by emailing <a href="mailto:${APP_EMAIL}">${APP_EMAIL}</a>.</p>

<h2>8. Changes to This Policy</h2>
<p>We may update this Privacy Policy from time to time. Continued use of the App after
changes constitutes acceptance of the updated policy.</p>

<h2>9. Contact Us</h2>
<p>Questions? Email us at <a href="mailto:${APP_EMAIL}">${APP_EMAIL}</a></p>
`));
  }
...
related services. If you do not agree, please do not use the App.</p>

<h2>2. Description of Service</h2>
<p>Kryupa provides health scores and ingredient analysis for consumer products.
...
<ul>
  ...
  <li>Reverse-engineer, hack, or disrupt the App or its servers.</li>
  <li>Submit false or misleading product data.</li>
  <li>Use automated tools to scrape or excessively query our API.</li>
</ul>

<h2>5. Disclaimer of Warranties</h2>
<p>The App is provided "as is" without warranty of any kind. Always consult a qualified
healthcare professional before making dietary or health decisions.</p>

<h2>6. Limitation of Liability</h2>
<p>To the maximum extent permitted by law, ${APP_NAME} shall not be liable for any
indirect, incidental, or consequential damages arising from your use of the App.</p>

<h2>7. Intellectual Property</h2>
<p>All content, branding, and code in the App is the property of ${APP_NAME}.
Product data sourced from Open Food Facts is licensed under the Open Database License (ODbL).</p>

<h2>8. Governing Law</h2>
<p>These Terms are governed by the laws of India. Disputes shall be resolved in
the courts of Pune, Maharashtra.</p>

<h2>9. Contact</h2>
<p>For questions, email <a href="mailto:${APP_EMAIL}">${APP_EMAIL}</a></p>
`));
  }
}
